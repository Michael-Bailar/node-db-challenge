...
- [x] Explain the difference between `Relational Databases` and `SQL`.
    SQL is a relational database. NoSQL is for non-structured databases.
- [x] Why do tables need a `primary key`?
    So that it's easier to keep things organized and linking tables is just easier with it. 
...
PROJECT LOCATION https://github.com/Michael-Bailar/node-db-challenge